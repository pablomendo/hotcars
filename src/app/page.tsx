...
import {
  ...
  ChevronLeft, ChevronRight, Clock, Instagram, CheckCircle2,
} from 'lucide-react';
  ...
  return (
    <>
      ...
      <a
        ...
        className="wa-float fixed bottom-24 right-5 md:bottom-6 z-[9999] w-14 h-14 md:w-16 md:h-16 bg-[#25d366] rounded-full flex items-center justify-center transition-transform duration-200 cursor-pointer"
      >
...
function MarketplaceContent() {
  ...
  useEffect(() => {
    supabase
      ...
      .range(0, 9)
      .then(({ data, error }) => {
        if (!error && data) setUltimosIngresos(data);
      });
  }, []);
  ...
  if (isLoading && inv.length === 0) return (
            ...
            <div className="relative w-full overflow-hidden bg-[#e2e8f0]">
              <div className="hidden md:block w-full relative">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-center"
                  style={{ paddingTop: '95px', paddingLeft: '2%', paddingRight: '55%' }}>
                  <h2 className="franklin-banner mb-3 uppercase w-full"
                    style={{ fontSize: 'clamp(23px, 3vw, 51px)', color: '#288b55', textShadow: '0 2px 14px rgba(0,0,0,0.5)' }}>
                    Red Privada de Vendedores
                  </h2>
                  <p className="genos-banner text-white/90 leading-[1.2] mb-6 w-full"
                  ...
                  <button onClick={() => router.push('/register')}
                    className="px-8 py-3 bg-transparent border-2 border-white text-white font-black uppercase tracking-widest text-[11px] rounded-lg hover:bg-white/10 transition-all cursor-pointer">
                    Quiero Vender Más
                  </button>
                </div>
              </div>
              <div className="md:hidden w-full relative">
                ...
                <div className="absolute inset-0 flex flex-col justify-end items-center text-center px-[6%] pb-[8%]"
                  ...
                  <h2 className="franklin-banner mb-2 uppercase w-full"
                    style={{ fontSize: 'clamp(22px, 6vw, 36px)', color: '#288b55', textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
                    Red Privada de Vendedores
                  </h2>
                  <p className="genos-banner text-white/90 leading-[1.2] mb-4 w-full"
                  ...
                  <button onClick={() => router.push('/register')}
                    className="px-6 py-2.5 bg-transparent border-2 border-white text-white font-black uppercase tracking-widest text-[10px] rounded-lg hover:bg-white/10 transition-all cursor-pointer">
                    Quiero Vender Más
                  </button>
                </div>
              </div>
            ...
            <div className="relative w-full overflow-hidden bg-[#e2e8f0]">
              <div className="hidden md:block w-full relative">
                ...
                <div className="absolute bottom-0 left-0 w-full h-[75px] pointer-events-none"
                  style={{ background: 'linear-gradient(to bottom, transparent, #288b55)' }} />
                <div className="absolute inset-0 flex flex-col justify-center items-center text-center"
                  style={{ paddingTop: '95px', paddingLeft: '55%', paddingRight: '2%' }}>
                  <h2 className="franklin-banner-right mb-3 uppercase w-full"
                    style={{ fontSize: 'clamp(23px, 3vw, 51px)', color: '#288b55', textShadow: '0 2px 14px rgba(0,0,0,0.5)' }}>
              ...
              <div className="md:hidden w-full relative">
                ...
                <div className="absolute inset-0 flex flex-col justify-end items-center text-center px-[6%] pb-[8%]"
                  style={{ paddingTop: '120px' }}>
                  <h2 className="franklin-banner-right mb-2 uppercase w-full"
                    style={{ fontSize: 'clamp(22px, 6vw, 36px)', color: '#288b55', textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
                    Tu Propia Agencia Online
                  </h2>
                  <p className="genos-banner text-white/90 leading-[1.25] mb-4 w-full"
                    style={{ fontSize: 'clamp(17px, 3.8vw, 22px)' }}>
        ...
        <section className="w-full bg-[#288b55] pt-10 pb-10">
          <div className="max-w-[1600px] mx-auto px-4 md:px-16">
            ...
            <div className="relative">
              ...
              >
                {ultimosIngresos.map((v) => {
                  const precio = v.pv !== null && v.pv !== undefined ? Number(v.pv) : null;
                  return (
                    <div
                      key={v.id}
                      onClick={() => {
            ...
            <div className="bg-[#1a232e] rounded-2xl p-8 border border-white/5 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex items-center gap-4 group">
                  <div className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-[#25d366]/20 border border-white/5 transition-all">
                    <svg viewBox="0 0 24 24" className="w-4 h-4 text-gray-400 group-hover:text-[#25d366] fill-current transition-colors" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                    </svg>
                  </div>
                  <a href="https://wa.me/5491178984773" target="_blank" rel="noopener noreferrer" className="text-gray-300 text-[15px] hover:text-[#25d366] transition-colors">
                    11 7898-4773
                  </a>
                </div>
