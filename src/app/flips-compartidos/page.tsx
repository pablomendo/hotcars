                                    ...
                                    <tr key={flip.id} className="text-sm hover:bg-slate-50 transition-colors">
                                        <td className="px-6 py-2">
                                            <Link href={`/inventario/${flip.inventario?.id}`} target="_blank" className="flex items-center gap-4 group cursor-pointer">
                                                ...
                                                <span className="font-bold text-slate-700 group-hover:text-[#22c55e] transition-colors">
                                        ...
                                        <td className="px-6 py-2 text-right">
                                            {flip.status === 'pending' && (
                                                <div className="flex justify-end gap-2">
                                                    <button onClick={() => handleUpdateStatus(flip.id, 'approved')} className="bg-[#22c55e] hover:bg-[#16a34a] text-white px-4 py-1.5 rounded text-xs font-bold transition-all cursor-pointer active:scale-95">Aceptar</button>
                                                    <button onClick={() => handleUpdateStatus(flip.id, 'rejected')} className="bg-[#ef4444] hover:bg-[#dc2626] text-white px-4 py-1.5 rounded text-xs font-bold transition-all cursor-pointer active:scale-95">Rechazar</button>
                                                </div>
                                            )}
                                        </td>
                                    </tr>
                                    ...
                                    <tr key={flip.id} className="text-sm hover:bg-slate-50 transition-colors">
                                        ...
                                        <td className="px-6 py-2 text-right">
                                            <button 
                                                ...
                                                className="border border-[#ef4444] text-[#ef4444] hover:bg-[#ef4444] hover:text-white px-3 py-1.5 rounded text-xs font-bold transition-all cursor-pointer flex items-center gap-1 ml-auto"
                                            >
